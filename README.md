...
| `docs/PRINTER_POSX_OPOS_HANDOFF.md` | Design + evidence for the printer OPOS step: how the package installs silently, every captured registry value, and the measured answers behind each decision. |
